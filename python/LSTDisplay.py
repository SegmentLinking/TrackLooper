...
class LSTDisplay:
    ...
    def __init__(self, det_geom):
        ...
        self.centroidDB = Centroid("/data2/segmentlinking/centroid_2020_0428.txt")
...
def test1():
    ...
    sdlDisplay = getDefaultLSTDisplay()
...
def test3():
    ...
    from Centroid import Centroid
    centroidDB = Centroid("/data2/segmentlinking/centroid_2020_0428.txt")
