...
if __name__ == "__main__":
    ...
    if metric == "eff": metricsuffix = "_"
    if metric == "duplrate": metricsuffix = "_duplrate_"
    if metric == "fakerate": metricsuffix = "_fakerate_"
    ...
    denom_histname = "Root__{objecttype}_AllTypes_h{metricsuffix}denom_{variable}".format(objecttype=objecttype, metricsuffix=metricsuffix, variable=variable)
    denom = f.Get(denom_histname).Clone()

    # Get numerator histograms
    numer_histname = "Root__{objecttype}_AllTypes_h{metricsuffix}numer_{variable}".format(objecttype=objecttype, metricsuffix=metricsuffix, variable=variable)
