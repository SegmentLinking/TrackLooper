...
// ----* Hit *----
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> convertHitsToHitIdxsAndHitTypes(SDL::Event<SDL::Acc>* event, std::vector<unsigned int> hits);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFrompLS(SDL::Event<SDL::Acc>* event, unsigned pLS);

// ----* MD *----
std::vector<unsigned int> getHitsFromMD(SDL::Event<SDL::Acc>* event, unsigned int MD);
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFromMD(SDL::Event<SDL::Acc>* event, unsigned MD);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFromLS(SDL::Event<SDL::Acc>* event, unsigned LS);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFromT3(SDL::Event<SDL::Acc>* event, unsigned T3);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFromT5(SDL::Event<SDL::Acc>* event, unsigned T5);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFrompT3(SDL::Event<SDL::Acc>* event, unsigned pT3);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFrompT5(SDL::Event<SDL::Acc>* event, unsigned pT5);
...
std::tuple<std::vector<unsigned int>, std::vector<unsigned int>> getHitIdxsAndHitTypesFromTC(SDL::Event<SDL::Acc>* event, unsigned int TC);
