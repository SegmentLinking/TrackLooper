...
void SDL::segments::resetMemory(unsigned int nMemoryLocationsx, unsigned int nLowerModules, unsigned int maxPixelSegments,cudaStream_t stream)
{
    ...
    cudaMemsetAsync(charge, 0,maxPixelSegments * sizeof(float),stream);
...
//    cudaStream_t stream=0; 
    ...
    segmentsInGPU.charge = (float*)cms::cuda::allocate_device(dev, maxPixelSegments * sizeof(float), stream);
    ...
    cudaMalloc(&segmentsInGPU.charge, maxPixelSegments * sizeof(float));
