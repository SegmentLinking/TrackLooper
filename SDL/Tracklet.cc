...
SDL::CPU::Tracklet::Tracklet(const Tracklet& tl) :
    TrackletBase(tl),
...
SDL::CPU::Tracklet::Tracklet(SDL::CPU::Segment* innerSegmentPtr, SDL::CPU::Segment* outerSegmentPtr) :
...
void SDL::CPU::Tracklet::addSelfPtrToSegments()
{
    innerSegmentPtr_->addOutwardTrackletPtr(this);
    outerSegmentPtr_->addInwardTrackletPtr(this);
}

const float& SDL::CPU::Tracklet::getDeltaBeta() const
{
    return deltaBeta_;
}

void SDL::CPU::Tracklet::setDeltaBeta(float deltaBeta)
{
    deltaBeta_ = deltaBeta;
}

const float& SDL::CPU::Tracklet::getDeltaBetaCut() const
{
    return deltaBetaCut_;
}

void SDL::CPU::Tracklet::setDeltaBetaCut(float deltaBetaCut)
{
    deltaBetaCut_ = deltaBetaCut;
}

const float& SDL::CPU::Tracklet::getBetaIn() const
{
    return betaIn_;
}

void SDL::CPU::Tracklet::setBetaIn(float betaIn)
{
    betaIn_ = betaIn;
}

const float& SDL::CPU::Tracklet::getBetaInCut() const
{
    return betaInCut_;
}

void SDL::CPU::Tracklet::setBetaInCut(float betaInCut)
{
    betaInCut_ = betaInCut;
}

const float& SDL::CPU::Tracklet::getBetaOut() const
{
    return betaOut_;
}

void SDL::CPU::Tracklet::setBetaOut(float betaOut)
{
    betaOut_ = betaOut;
}

const float& SDL::CPU::Tracklet::getBetaOutCut() const
{
    return betaOutCut_;
}

void SDL::CPU::Tracklet::setBetaOutCut(float betaOutCut)
{
    betaOutCut_ = betaOutCut;
}

void SDL::CPU::Tracklet::setNm1DeltaBetaCut(bool setNm1)
{
    setNm1DeltaBeta_ = setNm1;
}

bool SDL::CPU::Tracklet::getNm1DeltaBetaCut()
{
    return setNm1DeltaBeta_;
}

bool SDL::CPU::Tracklet::passesTrackletAlgo(SDL::CPU::TLAlgo algo) const
{
    // Each algorithm is an enum shift it by its value and check against the flag
    return passAlgo_ & (1 << algo);
}

void SDL::CPU::Tracklet::runTrackletAlgo(SDL::CPU::TLAlgo algo, SDL::CPU::LogLevel logLevel)
{
    if (algo == SDL::CPU::AllComb_TLAlgo)
    {
        runTrackletAllCombAlgo();
    }
    else if (algo == SDL::CPU::Default_TLAlgo)
    {
        runTrackletDefaultAlgo(logLevel);
    }
    else if (algo == SDL::CPU::DefaultNm1_TLAlgo)
    {
...
void SDL::CPU::Tracklet::runTrackletAllCombAlgo()
{
    passAlgo_ |= (1 << SDL::CPU::AllComb_TLAlgo);
}

void SDL::CPU::Tracklet::clearRecoVars()
{
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgo(SDL::CPU::LogLevel logLevel)
{
    ...
    {
        if (outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
           )
        {
            setRecoVars("algo", 4);
            runTrackletDefaultAlgoPixelBarrelBarrel(logLevel);
        }
        else if (outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
           )
        {
            setRecoVars("algo", 4);
            runTrackletDefaultAlgoPixelBarrelBarrel(logLevel);
        }
        else if (outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
           )
        {
            setRecoVars("algo", 5);
    ...
    else
    {
        ...
        if (innerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and innerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
           )
        {
            setRecoVars("algo", 1);
        ...
        else if (innerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and innerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Barrel
                and outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                )
        {
            setRecoVars("algo", 2);
                ...
                )
        {
            ...
            runTrackletDefaultAlgoBarrelBarrelBarrelBarrel(logLevel);
                ...
                and innerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                )
        {
        ...
        else if (innerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and innerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgInnerMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                and outerSgOuterMDLowerHitModule.subdet() == SDL::CPU::Module::Endcap
                )
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrelBarrelBarrel(SDL::CPU::LogLevel logLevel)
{
    runTrackletDefaultAlgoBarrelBarrelBarrelBarrel_v2(logLevel);
}

void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrelBarrelBarrel_v1(SDL::CPU::LogLevel logLevel)
{
    ...
    const float zGeom =
        ...
        +
        ((outerSegmentPtr()->innerMiniDoubletPtr()->anchorHitPtr()->getModule()).moduleType() == SDL::CPU::Module::PS ? pixelPSZpitch : strip2SZpitch);
    ...
    if (not (zOut >= zLo))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " zLo: " << zLo <<  " zOut: " << zOut <<  std::endl;
            SDL::CPU::cout <<  " zIn: " << zIn <<  std::endl;
            SDL::CPU::cout <<  " deltaZLum: " << deltaZLum <<  std::endl;
            SDL::CPU::cout <<  " rtOut_o_rtIn: " << rtOut_o_rtIn <<  std::endl;
            SDL::CPU::cout <<  " dzDrtScale: " << dzDrtScale <<  std::endl;
            SDL::CPU::cout <<  " zGeom: " << zGeom <<  std::endl;
        }
    ...
    if (not (zOut >= zLo and zOut <= zHi))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " zLo: " << zLo <<  " zOut: " << zOut <<  " zHi: " << zHi <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    if (not (zOut >= zLoPointed and zOut <= zHiPointed))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " zLoPointed: " << zLoPointed <<  " zOut: " << zOut <<  " zHiPointed: " << zHiPointed <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    if (not (std::abs(deltaPhiPos) <= sdlCut) )
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " deltaPhiPos: " << deltaPhiPos <<  " sdlCut: " << sdlCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    if (not (std::abs(dPhi) <= sdlCut))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " dPhi: " << dPhi <<  " sdlCut: " << sdlCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    const float sdOut_alphaOut_min = isEC_lastLayer ? SDL::CPU::MathUtil::Phi_mpi_pi(outerSegmentPtr()->getDeltaPhiMinChange() - outerSegmentPtr()->getDeltaPhiMin()) : sdOut_alphaOut;
    const float sdOut_alphaOut_max = isEC_lastLayer ? SDL::CPU::MathUtil::Phi_mpi_pi(outerSegmentPtr()->getDeltaPhiMaxChange() - outerSegmentPtr()->getDeltaPhiMax()) : sdOut_alphaOut;

    // // Shifting strip hits
    // SDL::CPU::Hit sdOut_mdOut_hit_hi = SDL::CPU::GeometryUtil::stripHighEdgeHit(sdOut_mdOut_hit);
    // SDL::CPU::Hit sdOut_mdOut_hit_lo = SDL::CPU::GeometryUtil::stripLowEdgeHit(sdOut_mdOut_hit);
    ...
    if (not (pass_betaIn_cut))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " betaInRHmin: " << betaInRHmin <<  " betaIn_cut: " << betaIn_cut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    if (not (std::abs(betaOut) < betaOut_cut))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            SDL::CPU::cout << "Failed Cut #7 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " betaOut: " << betaOut <<  " betaOut_cut: " << betaOut_cut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    // if (not (dBeta * dBeta <= 0.004*0.004))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            SDL::CPU::cout << "Failed Cut #8 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dBeta*dBeta: " << dBeta*dBeta <<  " dBetaCut2: " << dBetaCut2 <<  std::endl;
            SDL::CPU::cout <<  " dBetaRes: " << dBetaRes <<  " dBetaMuls: " << dBetaMuls <<  " dBetaLum2: " << dBetaLum2 <<  std::endl;
            SDL::CPU::cout <<  " dBetaRIn2: " << dBetaRIn2 <<  " dBetaROut2: " << dBetaROut2 <<  std::endl;
            SDL::CPU::cout <<  " betaInRHmin: " << betaInRHmin <<  " betaInRHmax: " << betaInRHmax <<  std::endl;
            SDL::CPU::cout <<  " betaOutRHmin: " << betaOutRHmin <<  " betaOutRHmax: " << betaOutRHmax <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        // passAlgo_ |= (1 << SDL::CPU::Default_TLAlgo);
        return;
    }
    else if (logLevel >= SDL::CPU::Log_Debug3)
    {
        SDL::CPU::cout << "Passed Cut #8 in " << __FUNCTION__ << std::endl;
        SDL::CPU::cout <<  " dBeta*dBeta: " << dBeta*dBeta <<  " dBetaCut2: " << dBetaCut2 <<  std::endl;
        SDL::CPU::cout <<  " dBetaRes: " << dBetaRes <<  " dBetaMuls: " << dBetaMuls <<  " dBetaLum2: " << dBetaLum2 <<  std::endl;
        SDL::CPU::cout <<  " dBetaRIn2: " << dBetaRIn2 <<  " dBetaROut2: " << dBetaROut2 <<  std::endl;
        SDL::CPU::cout <<  " betaInRHmin: " << betaInRHmin <<  " betaInRHmax: " << betaInRHmax <<  std::endl;
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrelBarrelBarrel_v3(SDL::CPU::LogLevel logLevel)
{
    ...
    const float zHi = z__inner_LS_inner_MD + zpitch__err
        + ((z__inner_LS_inner_MD + SDL::CPU::Constant::deltaZLum) * (rtRatio - 1.f) * (z__inner_LS_inner_MD < 0.f ? 1.f : dzDrtScale));
    ...
    if (not (z__outer_LS_inner_MD >= zLo and z__outer_LS_inner_MD <= zHi))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #2 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " zLo: " << zLo <<  " z__outer_LS_inner_MD: " << z__outer_LS_inner_MD <<  " zHi: " << zHi <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrelBarrelBarrel_v2(SDL::CPU::LogLevel logLevel)
{
    ...
    if (not (z_OutLo >= zLo and z_OutLo <= zHi))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #2 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " zLo: " << zLo <<  " z_OutLo: " << z_OutLo <<  " zHi: " << zHi <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    if (not (z_OutLo >= zLoPointed and z_OutLo <= zHiPointed))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #3 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " zLoPointed: " << zLoPointed <<  " z_OutLo: " << z_OutLo <<  " zHiPointed: " << zHiPointed <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_TLAlgo);
        return;
    }
    ...
    passAlgo_ |= (1 << SDL::CPU::Default_TLAlgo);
    if (getNm1DeltaBetaCut()) passAlgo_ |= (1 << SDL::CPU::DefaultNm1_TLAlgo);
    return;
}

void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrelEndcapEndcap(SDL::CPU::LogLevel logLevel)
{
    ...
    const bool isOutSgInnerMDPS = (outerSegmentPtr()->innerMiniDoubletPtr()->anchorHitPtr()->getModule()).moduleType() == SDL::CPU::Module::PS;
    ...
    const float sdOut_alphaOut = sdOut_mdOut_hit.deltaPhi(sdOut_mdOut_hit  - sdOut_mdRef_hit);
    const float sdOut_alphaOut_min = SDL::CPU::MathUtil::Phi_mpi_pi(outerSegmentPtr()->getDeltaPhiMinChange() - outerSegmentPtr()->getDeltaPhiMin());
    const float sdOut_alphaOut_max = SDL::CPU::MathUtil::Phi_mpi_pi(outerSegmentPtr()->getDeltaPhiMaxChange() - outerSegmentPtr()->getDeltaPhiMax());
    const Hit& sdOut_mdOut_r3 = (*outerSegmentPtr()->outerMiniDoubletPtr()->anchorHitPtr());
    const Hit dr3 = sdOut_mdOut_r3 - sdIn_r3;
    float betaIn  = sdIn_alpha - sdIn_r3.deltaPhi(dr3);
    float betaOut = -sdOut_alphaOut + sdOut_mdOut_r3.deltaPhi(dr3);
    const bool isEC_secondLayer = (innerSegmentPtr()->outerMiniDoubletPtr()->anchorHitPtr()->getModule().subdet() == SDL::CPU::Module::Endcap) and (innerSegmentPtr()->outerMiniDoubletPtr()->anchorHitPtr()->getModule().subdet() == SDL::CPU::Module::TwoS);
    ...
    // The hiEdge corresponds to the case where the strip hits are shifted to reach its edge
    const Hit& hit_OutUp_hiEdge = sdOut_mdOut_hit.getModule().moduleType() == SDL::CPU::Module::TwoS ? *sdOut_mdOut_hit.getHitHighEdgePtr() : sdOut_mdOut_hit;
    const Hit& hit_OutUp_loEdge = sdOut_mdOut_hit.getModule().moduleType() == SDL::CPU::Module::TwoS ? *sdOut_mdOut_hit.getHitLowEdgePtr() : sdOut_mdOut_hit;
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoEndcapEndcapEndcapEndcap(SDL::CPU::LogLevel logLevel)
{
    ...
    float sdOut_alphaOutRHmin = SDL::CPU::MathUtil::Phi_mpi_pi(sdOut_dPhiChange_min - sdOut_dPhiPos);
    float sdOut_alphaOutRHmax = SDL::CPU::MathUtil::Phi_mpi_pi(sdOut_dPhiChange_max - sdOut_dPhiPos);
    float sdOut_alphaOut = SDL::CPU::MathUtil::Phi_mpi_pi(sdOut_dPhiChange - sdOut_dPhiPos); // <--- This is for the endcap
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoDeltaBetaOnlyBarrelBarrelBarrelBarrel(SDL::CPU::LogLevel logLevel)
{
    const float deltaZLum = 15.f;
    const float pixelPSZpitch = 0.15;
    const float strip2SZpitch = 5.0;
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelBarrel(SDL::CPU::LogLevel logLevel)
{
    return;
}

void SDL::CPU::Tracklet::runTrackletDefaultAlgoBarrelEndcap(SDL::CPU::LogLevel logLevel)
{
    return;
}

void SDL::CPU::Tracklet::runTrackletDefaultAlgoEndcapEndcap(SDL::CPU::LogLevel logLevel)
{
    return;
}

void SDL::CPU::Tracklet::runTrackletDefaultAlgoPixelBarrelBarrel(SDL::CPU::LogLevel logLevel)
{
    ...
    SDL::CPU::Hit pixelMomentumVec(px, py, pz);
...
void SDL::CPU::Tracklet::runTrackletDefaultAlgoPixelEndcapEndcap(SDL::CPU::LogLevel logLevel)
{
...
void SDL::CPU::Tracklet::runDeltaBetaIterations(float& betaIn, float& betaOut, float& betaAv, float& pt_beta, float sdIn_dr, float sdOut_dr, float dr, int lIn, float pt_betaMax)
{
    const float kRinv1GeVf = (2.99792458e-3 * 3.8);
    const float k2Rinv1GeVf = kRinv1GeVf / 2.;
    const float sinAlphaMax = 0.95;
...
[[deprecated("SDL::CPU:: isSegmentPairATracklet() is deprecated")]]
bool SDL::CPU::Tracklet::isSegmentPairATracklet(const Segment& innerSegment, const Segment& outerSegment, TLAlgo algo, SDL::CPU::LogLevel logLevel)
{
...
bool SDL::CPU::Tracklet::isSegmentPairATrackletBarrel(const Segment& innerSegment, const Segment& outerSegment, TLAlgo algo, SDL::CPU::LogLevel logLevel)
{
    return false;
}

bool SDL::CPU::Tracklet::isSegmentPairATrackletEndcap(const Segment& innerSegment, const Segment& outerSegment, TLAlgo algo, SDL::CPU::LogLevel logLevel)
{
    return false;
}
