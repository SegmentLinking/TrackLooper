    ...
    namespace CPU
    {
        class Segment
        {
            ...
            public:
                ...
                void runSegmentAlgo(SGAlgo algo, SDL::CPU::LogLevel logLevel=SDL::CPU::Log_Nothing);

                // The following algorithm does nothing and accept everything
                void runSegmentAllCombAlgo();

                // The default algorithms
                void runSegmentDefaultAlgo(SDL::CPU::LogLevel logLevel);
                void runSegmentDefaultAlgoBarrel(SDL::CPU::LogLevel logLevel);
                void runSegmentDefaultAlgoEndcap(SDL::CPU::LogLevel logLevel);
                ...
                static bool isMiniDoubletPairASegment(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel=SDL::CPU::Log_Nothing);
                static bool isMiniDoubletPairASegmentCandidateBarrel(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel=SDL::CPU::Log_Nothing);
                static bool isMiniDoubletPairASegmentCandidateEndcap(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel=SDL::CPU::Log_Nothing);
                static bool isMiniDoubletPairAngleCompatibleEndcap(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel=SDL::CPU::Log_Nothing);
                std::unordered_map<std::string,float> dAlphaThreshold(const SDL::CPU::MiniDoublet &innerMiniDoublet, const SDL::CPU::MiniDoublet &outerMiniDoublet);
