...
namespace SDL
{
  ...
  CUDA_DEV void rmQuintupletToMemory(struct SDL::quintuplets& quintupletsInGPU, unsigned int quintupletIndex);
    ...
    CUDA_DEV bool T5HasCommonMiniDoublet(struct triplets& tripletsInGPU, struct triplets& tripletsInwardInGPU, struct segments& segmentsInGPU, unsigned int innerTripletIndex, unsigned int outerTripletIndex);
