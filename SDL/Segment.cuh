...
namespace SDL
{
    ...
    __global__ void createSegmentArrayRanges(struct modules& modulesInGPU, struct objectRanges& rangesInGPU, struct miniDoublets& mdsinGPU, unsigned int* nSegments, cudaStream_t stream, const uint16_t* maxPixelSegments, unsigned int* moduleOccupancy);
