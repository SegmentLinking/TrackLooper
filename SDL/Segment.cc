...
SDL::CPU::Segment::Segment(const Segment& sg) :
...
SDL::CPU::Segment::Segment(SDL::CPU::MiniDoublet* innerMiniDoubletPtr, SDL::CPU::MiniDoublet* outerMiniDoubletPtr) :
...
void SDL::CPU::Segment::addSelfPtrToMiniDoublets()
{
    innerMiniDoubletPtr_->addOutwardSegmentPtr(this);
    outerMiniDoubletPtr_->addInwardSegmentPtr(this);
}

const std::vector<SDL::CPU::Tracklet*>& SDL::CPU::Segment::getListOfOutwardTrackletPtrs()
{
    return outwardTrackletPtrs;
}

const std::vector<SDL::CPU::Tracklet*>& SDL::CPU::Segment::getListOfInwardTrackletPtrs()
{
    return inwardTrackletPtrs;
}

void SDL::CPU::Segment::addOutwardTrackletPtr(SDL::CPU::Tracklet* tl)
{
    outwardTrackletPtrs.push_back(tl);
}

void SDL::CPU::Segment::addInwardTrackletPtr(SDL::CPU::Tracklet* tl)
{
...
SDL::CPU::MiniDoublet* SDL::CPU::Segment::outerMiniDoubletPtr() const
{
    return outerMiniDoubletPtr_;
}

const int& SDL::CPU::Segment::getPassAlgo() const
{
    return passAlgo_;
}

const int& SDL::CPU::Segment::getPassBitsDefaultAlgo() const
{
    return passBitsDefaultAlgo_;
}

const float& SDL::CPU::Segment::getRtOut() const
{
    return rtOut_;
}

const float& SDL::CPU::Segment::getRtIn() const
{
    return rtIn_;
}

const float& SDL::CPU::Segment::getDeltaPhi() const
{
    return dphi_;
}

const float& SDL::CPU::Segment::getDeltaPhiMin() const
{
    return dphi_min_;
}

const float& SDL::CPU::Segment::getDeltaPhiMax() const
{
    return dphi_max_;
}

const float& SDL::CPU::Segment::getDeltaPhiChange() const
{
    return dphichange_;
}

const float& SDL::CPU::Segment::getDeltaPhiMinChange() const
{
    return dphichange_min_;
}

const float& SDL::CPU::Segment::getDeltaPhiMaxChange() const
{
    return dphichange_max_;
}

const float& SDL::CPU::Segment::getZOut() const
{
    return zOut_;
}

const float& SDL::CPU::Segment::getZIn() const
{
    return zIn_;
}

const float& SDL::CPU::Segment::getZLo() const
{
    return zLo_;
}

const float& SDL::CPU::Segment::getZHi() const
{
    return zHi_;
}

const float& SDL::CPU::Segment::getRtLo() const
{
    return rtLo_;
}

const float& SDL::CPU::Segment::getRtHi() const
{
    return rtHi_;
}

const std::map<std::string, float>& SDL::CPU::Segment::getRecoVars() const
{
    return recovars_;
}

const float& SDL::CPU::Segment::getRecoVar(std::string key) const
{
    return recovars_.at(key);
}

const float& SDL::CPU::Segment::getdAlphaInnerMDSegment() const
{
    return dAlphaInnerMDSegment_;
}

const float& SDL::CPU::Segment::getdAlphaOuterMDSegment() const
{
    return dAlphaOuterMDSegment_;
}

const float& SDL::CPU::Segment::getdAlphaInnerMDOuterMD() const
{
    return dAlphaInnerMDOuterMD_;
}

void SDL::CPU::Segment::setRtOut(float rt)
{
    rtOut_ = rt;
}

void SDL::CPU::Segment::setRtIn(float rt)
{
    rtIn_ = rt;
}

void SDL::CPU::Segment::setRtLo(float rt)
{
    rtLo_ = rt;
}

void SDL::CPU::Segment::setRtHi(float rt)
{
    rtHi_ = rt;
}

void SDL::CPU::Segment::setDeltaPhi(float dphi)
{
    dphi_ = dphi;
}

void SDL::CPU::Segment::setDeltaPhiMin(float dphimin)
{
    dphi_min_ = dphimin;
}

void SDL::CPU::Segment::setDeltaPhiMax(float dphimax)
{
    dphi_max_ = dphimax;
}

void SDL::CPU::Segment::setDeltaPhiChange(float dphichange)
{
    dphichange_ = dphichange;
}

void SDL::CPU::Segment::setDeltaPhiMinChange(float dphichangemin)
{
    dphichange_min_ = dphichangemin;
}

void SDL::CPU::Segment::setDeltaPhiMaxChange(float dphichangemax)
{
    dphichange_max_ = dphichangemax;
}

void SDL::CPU::Segment::setZOut(float zOut)
{
    zOut_ = zOut;
}

void SDL::CPU::Segment::setZIn(float zIn)
{
    zIn_ = zIn;
}

void SDL::CPU::Segment::setZLo(float zLo)
{
    zLo_ = zLo;
}

void SDL::CPU::Segment::setZHi(float zHi)
{
    zHi_ = zHi;
}

void SDL::CPU::Segment::setRecoVars(std::string key, float var)
{
    recovars_[key] = var;
}

void SDL::CPU::Segment::setdAlphaInnerMDSegment(float var)
{
    dAlphaInnerMDSegment_ = var;
}

void SDL::CPU::Segment::setdAlphaOuterMDSegment(float var)
{
    dAlphaOuterMDSegment_ = var;
}

void SDL::CPU::Segment::setdAlphaInnerMDOuterMD(float var)
{
    dAlphaInnerMDOuterMD_ = var;
}


bool SDL::CPU::Segment::passesSegmentAlgo(SDL::CPU::SGAlgo algo) const
{
    // Each algorithm is an enum shift it by its value and check against the flag
    return passAlgo_ & (1 << algo);
}

void SDL::CPU::Segment::runSegmentAlgo(SDL::CPU::SGAlgo algo, SDL::CPU::LogLevel logLevel)
{
    if (algo == SDL::CPU::AllComb_SGAlgo)
    {
        runSegmentAllCombAlgo();
    }
    else if (algo == SDL::CPU::Default_SGAlgo)
    {
...
void SDL::CPU::Segment::runSegmentAllCombAlgo()
{
    ...
    // if (not (dr < 35.))
    // {
    //     passAlgo_ &= (0 << SDL::CPU::AllComb_SGAlgo);
    //     return;
    // }
...
void SDL::CPU::Segment::runSegmentDefaultAlgo(SDL::CPU::LogLevel logLevel)
{
    ...
    {
        if (outerLowerModule.subdet() == SDL::CPU::Module::Barrel)
        {
    ...
    {
        if (outerLowerModule.subdet() == SDL::CPU::Module::Endcap)
            runSegmentDefaultAlgoEndcap(logLevel);
...
void SDL::CPU::Segment::runSegmentDefaultAlgoBarrel(SDL::CPU::LogLevel logLevel)
{
    ...
    // // bool isOuterEndcap = (outerLowerModule.subdet() == SDL::CPU::Module::Endcap);
    ...
    //         SDL::CPU::cout <<  " innerLowerModule.detId(): " << innerLowerModule.detId() <<  " outerLowerModule.detId(): " << outerLowerModule.detId() << std::endl;
    //     }
    //     passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
    //     return;
    // }
    ...
    const Hit& innerMiniDoubletAnchorHit = (innerLowerModule.moduleType() == SDL::CPU::Module::PS) ? ( (innerLowerModule.moduleLayerType() == SDL::CPU::Module::Pixel) ? *innerMiniDoublet.lowerHitPtr() : *innerMiniDoublet.upperHitPtr()): *innerMiniDoublet.lowerHitPtr();
    const Hit& outerMiniDoubletAnchorHit = (outerLowerModule.moduleType() == SDL::CPU::Module::PS) ? ( (outerLowerModule.moduleLayerType() == SDL::CPU::Module::Pixel) ? *outerMiniDoublet.lowerHitPtr() : *outerMiniDoublet.upperHitPtr()): *outerMiniDoublet.lowerHitPtr();
    ...
    if (not (outerMiniDoubletAnchorHitZ >= zLo and outerMiniDoubletAnchorHitZ <= zHi))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " zLo: " << zLo <<  " outerMiniDoubletAnchorHitZ: " << outerMiniDoubletAnchorHitZ <<  " zHi: " << zHi <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(deltaPhi) <= sdCut))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " deltaPhi: " << deltaPhi <<  " sdCut: " << sdCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(getDeltaPhiChange()) <= sdCut))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " deltaPhiChange: " << getDeltaPhiChange() <<  " sdCut: " << sdCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
...
//    float sdRt = innerMiniDoubletAnchorHit.rt();
    ...
    if (not (std::abs(dAlpha_inner_md_sg) < dAlpha_compat_inner_vs_sg))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            ...
            SDL::CPU::cout <<  " dAlpha_inner_md_sg: " << dAlpha_inner_md_sg <<  " dAlpha_compat_inner_vs_sg: " << dAlpha_compat_inner_vs_sg <<  std::endl;
//            SDL::CPU::cout <<  " dAlpha_Bfield: " << dAlpha_Bfield <<  " dAlpha_res: " << dAlpha_res <<  " sdMuls: " << sdMuls <<  " sdLumForInnerMini: " << sdLumForInnerMini <<  std::endl;
            SDL::CPU::cout <<  " inner_md_alpha: " << inner_md_alpha <<  " sg_alpha: " << sg_alpha <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(dAlpha_outer_md_sg) < dAlpha_compat_outer_vs_sg))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            SDL::CPU::cout << "Failed Cut #5 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dAlpha_outer_md_sg: " << dAlpha_outer_md_sg <<  " dAlpha_compat_outer_vs_sg: " << dAlpha_compat_outer_vs_sg <<  std::endl;
//            SDL::CPU::cout <<  " dAlpha_Bfield: " << dAlpha_Bfield <<  " dAlpha_res: " << dAlpha_res <<  " sdMuls: " << sdMuls <<  " sdLumForOuterMini: " << sdLumForOuterMini <<  std::endl;
            SDL::CPU::cout <<  " outer_md_alpha: " << outer_md_alpha <<  " sg_alpha: " << sg_alpha <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(dAlpha_outer_md_inner_md) < dAlpha_compat_inner_vs_outer))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            SDL::CPU::cout << "Failed Cut #6 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dAlpha_outer_md_inner_md: " << dAlpha_outer_md_inner_md <<  " dAlpha_compat_inner_vs_outer: " << dAlpha_compat_inner_vs_outer <<  std::endl;
//            SDL::CPU::cout <<  " dAlpha_Bfield: " << dAlpha_Bfield <<  " dAlpha_res: " << dAlpha_res <<  " sdMuls: " << sdMuls <<  " sdLumForInnerMini: " << sdLumForInnerMini <<  " sdLumForOuterMini: " << sdLumForOuterMini <<  std::endl;
            SDL::CPU::cout <<  " outer_md_alpha: " << outer_md_alpha <<  " inner_md_alpha: " << inner_md_alpha <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    passAlgo_ |= (1 << SDL::CPU::Default_SGAlgo);
    return;
}

void SDL::CPU::Segment::runSegmentDefaultAlgoEndcap(SDL::CPU::LogLevel logLevel)
{
    const MiniDoublet& innerMiniDoublet = (*innerMiniDoubletPtr());
    const MiniDoublet& outerMiniDoublet = (*outerMiniDoubletPtr());
    ...
    const bool outerLayerEndcapTwoS = outerLowerModule.moduleType() == SDL::CPU::Module::TwoS and outerLowerModule.subdet() == SDL::CPU::Module::Endcap;
    ...
    if (innerMiniDoubletAnchorHitZ * outerMiniDoubletAnchorHitZ < 0)
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #0 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " innerMiniDoubletAnchorHitZ: " << innerMiniDoubletAnchorHitZ <<  " outerMiniDoubletAnchorHitZ: " << outerMiniDoubletAnchorHitZ <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
    ...
    if (not (outerMiniDoubletAnchorHitRt >= rtLo and outerMiniDoubletAnchorHitRt <= rtHi))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #1 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " rtLo: " << rtLo <<  " outerMiniDoubletAnchorHitRt: " << outerMiniDoubletAnchorHitRt <<  " rtHi: " << rtHi <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(dPhiPos) <= sdCut))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #2 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dPhiPos: " << dPhiPos <<  " sdCut: " << sdCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
    ...
    if (not (std::abs(getDeltaPhiChange()) <= sdCut))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #3 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dPhiChange: " << getDeltaPhiChange() <<  " sdCut: " << sdCut <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
    }
...
//    float sdRt = innerMiniDoubletAnchorHit.rt();
    ...
    if (not (std::abs(dAlpha_outer_md_inner_md) < dAlpha_compat_inner_vs_outer))
    {
        if (logLevel >= SDL::CPU::Log_Debug3)
        {
            SDL::CPU::cout << "Failed Cut #6 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dAlpha_outer_md_inner_md: " << dAlpha_outer_md_inner_md <<  " dAlpha_compat_inner_vs_outer: " << dAlpha_compat_inner_vs_outer <<  std::endl;
//            SDL::CPU::cout <<  " dAlpha_Bfield: " << dAlpha_Bfield <<  " dAlpha_res: " << dAlpha_res <<  " sdMuls: " << sdMuls <<  " dAlpha_uncRt: " << dAlpha_uncRt <<  " sdLumForInnerMini: " << sdLumForInnerMini <<  " sdLumForOuterMini: " << sdLumForOuterMini <<  std::endl;
//            SDL::CPU::cout <<  " sdZ: " << sdZ <<  " sdRt: " << sdRt <<  " miniDelta: " << miniDelta <<  std::endl;
//            SDL::CPU::cout <<  " segmentDr: " << segmentDr <<  " k2Rinv1GeVf: " << k2Rinv1GeVf <<  " ptCut: " << ptCut <<  " sinAlphaMax: " << sinAlphaMax <<  std::endl;
            SDL::CPU::cout <<  " outer_md_alpha: " << outer_md_alpha <<  " inner_md_alpha: " << inner_md_alpha <<  std::endl;
        }
        passAlgo_ &= (0 << SDL::CPU::Default_SGAlgo);
        return;
...
bool SDL::CPU::Segment::hasCommonMiniDoublet(const Segment& outer_sg) const
{
...
bool SDL::CPU::Segment::isIdxMatched(const Segment& sg) const
{
...
bool SDL::CPU::Segment::isAnchorHitIdxMatched(const Segment& sg) const
{
...
std::unordered_map<std::string,float> SDL::CPU::Segment::dAlphaThreshold(const SDL::CPU::MiniDoublet &innerMiniDoublet, const SDL::CPU::MiniDoublet &outerMiniDoublet)
{
    ...
    float sdMuls = (innerLowerModule.subdet() == SDL::CPU::Module::Barrel) ? miniMulsPtScaleBarrel[innerLowerModule.layer()-1] * 3.f/ptCut : miniMulsPtScaleEndcap[innerLowerModule.layer()-1] * 3.f/ptCut;
...
//    const float sdPVoff = 0.1f/segmentDr;
    ...
    const bool isInnerTilted = innerLowerModule.subdet() == SDL::CPU::Module::Barrel and innerLowerModule.side() != SDL::CPU::Module::Center;
    const bool isOuterTilted = outerLowerModule.subdet() == SDL::CPU::Module::Barrel and outerLowerModule.side() != SDL::CPU::Module::Center;
    const unsigned int innerdetid = (innerLowerModule.moduleLayerType() == SDL::CPU::Module::Pixel) ?  innerLowerModule.partnerDetId() : innerLowerModule.detId();
    const unsigned int outerdetid = (outerLowerModule.moduleLayerType() == SDL::CPU::Module::Pixel) ?  outerLowerModule.partnerDetId() : outerLowerModule.detId();
    const float drdzinner = tiltedGeometry.getDrDz(innerdetid);
    const float drdzouter = tiltedGeometry.getDrDz(outerdetid);
    const float innerminiTilt = isInnerTilted ? (0.5f * pixelPSZpitch * drdzinner / sqrt(1.f + drdzinner * drdzinner) / SDL::CPU::MiniDoublet::moduleGapSize(innerLowerModule)) : 0;
    const float outerminiTilt = isOuterTilted ? (0.5f * pixelPSZpitch * drdzouter / sqrt(1.f + drdzouter * drdzouter) / SDL::CPU::MiniDoublet::moduleGapSize(outerLowerModule)) : 0;


    float miniDelta = SDL::CPU::MiniDoublet::moduleGapSize(innerLowerModule); 
    ...
    {
        if (innerLowerModule.moduleType() == SDL::CPU::Module::PS)
    ...
    {
        if (outerLowerModule.moduleType() == SDL::CPU::Module::PS)
    ...
    float dAlpha_res_inner = 0.02f/miniDelta * (innerLowerModule.subdet() == SDL::CPU::Module::Barrel ? 1.0f : std::abs(innerMiniDoubletAnchorHitZ/innerMiniDoubletAnchorHitRt));
    float dAlpha_res_outer = 0.02f/miniDelta * (outerLowerModule.subdet() == SDL::CPU::Module::Barrel ? 1.0f : std::abs(outerMiniDoubletAnchorHitZ/outerMiniDoubletAnchorHitRt));

    float dAlpha_res = dAlpha_res_inner + dAlpha_res_outer;

    if (innerLowerModule.subdet() == SDL::CPU::Module::Barrel and innerLowerModule.side() == SDL::CPU::Module::Center)
    {
    ...
    if (outerLowerModule.subdet() == SDL::CPU::Module::Barrel and outerLowerModule.side() == SDL::CPU::Module::Center)
    {
...
[[deprecated("SDL::CPU:: isMiniDoubletPairASegment() is deprecated")]]
bool SDL::CPU::Segment::isMiniDoubletPairASegment(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel)
{
    ...
    else if (algo == SDL::CPU::Default_SGAlgo)
    {
        ...
        // if (innerLowerModule.subdet() == SDL::CPU::Module::Barrel and outerLowerModule.subdet() == SDL::CPU::Module::Barrel)
        if (innerLowerModule.subdet() == SDL::CPU::Module::Barrel)
        {
            if (not isMiniDoubletPairASegmentCandidateBarrel(innerMiniDoublet, outerMiniDoublet, algo, logLevel))
                return false;
        }
        else // if (innerLowerModule.subdet() == SDL::CPU::Module::Endcap)
        {
...
bool SDL::CPU::Segment::isMiniDoubletPairASegmentCandidateBarrel(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel)
{
    ...
    if (not (std::abs(dPhiChange) <= sdCut))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #3 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " deltaPhiChange: " << dPhiChange <<  " sdCut: " << sdCut <<  std::endl;
        }
        return false;
    }
...
bool SDL::CPU::Segment::isMiniDoubletPairASegmentCandidateEndcap(const MiniDoublet& innerMiniDoublet, const MiniDoublet& outerMiniDoublet, SGAlgo algo, SDL::CPU::LogLevel logLevel)
{
    ...
    if (not (std::abs(dPhiChange) <= sdCut))
    {
        ...
        {
            SDL::CPU::cout << "Failed Cut #3 in " << __FUNCTION__ << std::endl;
            SDL::CPU::cout <<  " dPhiChange: " << dPhiChange <<  " sdCut: " << sdCut <<  std::endl;
        }
        return false;
    }
...
namespace SDL
{
    namespace CPU
    {
        std::ostream& operator<<(std::ostream& out, const Segment& sg)
        {
            ...
            out << "ptestimate " << SDL::CPU::MathUtil::ptEstimateFromDeltaPhiChangeAndRt(sg.getDeltaPhiChange(), sg.getRtOut()) << std::endl;
            out << std::endl;
